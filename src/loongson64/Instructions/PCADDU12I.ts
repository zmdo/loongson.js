...
namespace LoongarchTemplate {
     ...
     * @param si20 20位立即数
     */
    export function PCADDU12I ( _LRG:LoongsonRegisterGroup, rd:number, si20:number ) : void {
        // tmp = SignExtend({si20,12'b0},GRLEN)
        let tmp = Int64.cast(SignExtend(si20 << 12,32,_LRG.GRLEN));
        // GR[rd] = PC + tmp
